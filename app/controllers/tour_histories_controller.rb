class TourHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tour_history.save
        format.html { redirect_to @tour_history, notice: 'Tour history was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @tour_history.update_attributes(params[:tour_history])
        format.html { redirect_to @tour_history, notice: 'Tour history was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tour_histories_url }
      format.json { head :no_content }
    end
  end
end
